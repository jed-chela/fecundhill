    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 mb-sm-40">
          <h4 class="font-alt">All Transactions</h4>
                  ...
                  <!--      <th></th> -->
                    ...
                    <tbody>
                      <?php
                        ...
                        $records = $this->Finance->getTransactions($this->Users->getUserID());
                        if ($records !== false) {
                              ...
                              foreach ($records as $index => $record) {
                                ...
                                switch ($record['type']) {
                                  ...
                                  case 10:
                                    ...
                                    break;
                                  case 11:
                                    $transaction_label = "Ride payment";
                                    $balance += $record["amount"];
                                    $account_type = "";
                                    break;
                                  case 12:
                                    $transaction_label = "Hire purchase payment";
                                    $balance += $record["amount"];
                                    $account_type = "";
                                    break;
                                  case 13:

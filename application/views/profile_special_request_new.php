    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 mb-sm-40">
          <h4 class="font-alt">REQUEST OUR SERVICES</h4>
        ...
        if ($verify_account_status['status'] == 9) {
          ...
          <div class='col-sm-12 mb-sm-12'>
            <div class="col-lg-12">
              <?php
                if ($hide_cat_1 == "") {
                  ?>
                  <a href="<?php echo base_url(); ?>profile/real_estate_home" class="btn btn-primary btn-xs">
                    Back to Real Estate Dashboard
                  </a>
                  <?php
                }
                if ($hide_cat_2 == "") {
          ...
          <hr class="divider-w mb-10">
          <h4 class='col-sm-12 col-sm-offset-1 mb-sm-10'> </h4>
            ...
            <div class='col-sm-10 mb-sm-8'>
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="msg_category" required>
                      ...
                      <?php
                        if ($hide_cat_1 == "") {
                          echo "<option value=1>Real Estate</option>";
                        }
                        if ($hide_cat_2 == "") {
                          echo "<option value=2>Transport</option>";
                        }
                        if ($hide_cat_3 == "") {
                          echo "<option value=3>Finance</option>";
                        }
                      ?>
                ...
                <!--      <input type="checkbox" name="sub_cat[]" value="Hire Purchase" /> Hire Purchase<br />  -->
                      <input type="checkbox" name="sub_cat[]" value="Platinum Ride" /> Platinum Ride<br />
          ...
          <!--            <input type="checkbox" name="sub_cat[]" value="Certificate of Occupancy" /> Certificate of Occupancy<br />
                    ...
                    -->
                      <input type="checkbox" name="sub_cat[]" value="Property Purchase" /> Property Purchase<br />
                      <input type="checkbox" name="sub_cat[]" value="Building Design" /> Building Design<br />
                      <input type="checkbox" name="sub_cat[]" value="Building Construction" /> Building Construction<br />
                    <?php
                      }
                      ?>
                ...
                <!--    <label for="msg_location">Location</label>  -->
                    <label for="msg_location">Departure city</label>
                ...
                <!--    <label for="msg_destination">Destination</label> -->
                    <label for="msg_destination">Pick-up Location  ➖️  Stop locations ➖️ Drop-off location (Landmarks)</label>
                    <input class="form-control" type="text" name="msg_destination" id="msg_destination" required style="text-transform: none;">
                  </div>
                  <?php
                      }else{
                  ?>
                      <input type="hidden" name="msg_destination" id="msg_destination" value="" >
                  <?php
                      }
                  ?>
                  <div class="form-group mb-10">
                <!--    <label for="msg_subject">Title</label> -->
                    <label for="msg_subject">Passenger seating capacity (4 or 6)</label>
                    <input class="form-control" type="text" name="msg_subject" id="msg_subject" required style="text-transform: none;">
                  </div>
                  <div class="form-group mb-10">
                <!--    <label for="msg_body">Specification</label> -->
                    <label for="msg_body">Preferred vehicle type</label>
                  ...
                  <div class="form-group">
                    <input type="submit" name="special_request_submit" class="btn btn-primary">
                  </div>

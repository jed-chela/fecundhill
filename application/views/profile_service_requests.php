    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 mb-sm-40">
          <h4 class="font-alt">My Service Requests</h4>
        ...
        if ($verify_account_status['status'] == 9) {
          ...
          <?php
            ...
            $admin_messages = $this->Personal->getAdminServiceRequestsByUser($this->Users->getUserID());
                ...
                <?php   /*   <th>Opened</th>  */ ?>
                  ...
                  <tbody>
                    <?php
                      ...
                      if ($admin_messages !== false) {
                        foreach ($admin_messages as $index => $message) {
                          ...
                          $o .= "<td>" . $message['category'] . "</td>";
                          $o .= "<td>" . $message['sub_category'] . "</td>";
                          $o .= "<td>" . $message['location']. ( $message['destination'] ? (" | ".$message['destination']) : "") . "</td>";
                    ...
                    //      $o .= "<td>" . $message_opened_time_label . "</td>";
                          $o .= "<td>";
                            $o .= "<a href='".base_url()."profile/service_request_view/". $message['id']."' class='btn btn-xs btn-default' >View</a>";
                          $o .= "</td>";
                          $o .= "</tr>";
                        }
                      }

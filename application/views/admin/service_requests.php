    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 mb-sm-40">
          <h4 class="font-alt">SERVICE REQUESTS TO FECUNDHILL</h4>
        ...
        if ($verify_account_status['status'] == 9) {
          ...
          <?php
            ...
            $admin_messages = $this->Personal->getAdminServiceRequests();
                    ...
                    <?php
                      ...
                      if ($admin_messages !== false) {
                        foreach ($admin_messages as $index => $message) {
                          ...
                          $o .= "<td>" . $category_label . "</td>";
                          $o .= "<td>" . $message['sub_category'] . "</td>";
                          $o .= "<td>" . $message['location'] . "</td>";
                          ...
                          $o .= "<td>";
                          $o .= "<a href='" . base_url() . "admin/service_request_view/" . $message['id'] . "' class='btn btn-xs btn-default' >View</a>";
                          $o .= "</td>";
                          $o .= "</tr>";
                        }
                      }

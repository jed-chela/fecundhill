    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 mb-sm-40">
          <h4 class="font-alt">Loan Requests History for All Users</h4>
              ...
              <!--          <th class="">Children</th>      -->
                    ...
                    <tbody>
                      <?php
                            ...
                            $o = "";
                            $records_all = $this->Finance->getAllLoanRequests();
                          ...
                          */
                                $o .= "<tr>";
                                $o .= "<td>" . ($index + 1) . "</td>";
                                $o .= "<td><a class='visible-links' href='".base_url()."admin/view_loan_requests_history/".$record["user_id"]."'>" . $title . " " . $surname . " " . $firstname . "</a></td>";

      ...
      <div class="row">
        ...
        if ($verify_account_status['status'] == 9) {
          ...
          <div class='col-sm-12 mb-sm-12'>
            ...
            <div class="row">
              <div class="col-sm-12">
                <a href="<?php echo base_url(); ?>admin/service_requests" style="text-decoration: none; color:blue;" >Back to Service Requests</a>
                <?php
                  if ($message !== false) {
                  
                    $recipient_label = "Received";
                    if ($message['type'] == 1) {
                      $recipient_label = "Sent";
                    }
                    ...
                    $o .= "<div>";
                      ...
                      $o .= "<h4><i><b>" . $message['location'] . "</b></i></h4>";

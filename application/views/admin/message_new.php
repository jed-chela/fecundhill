              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-10">
                  ...
                  <div class="form-group mb-10">
                    <label for="member_text">Select Recipient</label>
                    <input id='member_id' name='member_id' type='hidden' value="" required>
                    <div class='typeahead-container'>
                      <div class='row col-sm-12'>
                        <div class='typeahead-field'>
                          <span class='typeahead-query'>
                            <input id='member_text' class="form-control" type='search' autocomplete='off'>
                          </span>
                        </div>
                      </div>
                    </div>

    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 mb-sm-40">
          <h4 class="font-alt">MESSAGES AND NOTIFICATIONS</h4>
        ...
        if ($verify_account_status['status'] == 9) {
          ...
          <?php
            ...
            $admin_messages = $this->Personal->getMyMessages($this->Users->getUserID());
                ...
                <?php   /*   <th>Opened</th>  */ ?>
                  ...
                  <tbody>
                    ...
                    //      $o .= "<td>" . $message_opened_time_label . "</td>";
                          $o .= "<td>";
                            $o .= "<a href='".base_url()."profile/message_view/". $message['id']."' class='btn btn-xs btn-default' >View</a>";
                          $o .= "</td>";
                          $o .= "</tr>";
                        }
                      }

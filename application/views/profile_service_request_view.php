    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 mb-sm-40">
          <h4 class="font-alt">VIEW SERVICE REQUEST</h4>
        ...
        if ($verify_account_status['status'] == 9) {
          ...
          <div class='col-sm-12 mb-sm-12'>
            ...
            <div class="row">
              <div class="col-sm-12">
                <a href="<?php echo base_url(); ?>profile/service_requests" style="text-decoration: none; color:blue;" >Back to My Service Requests</a>
                <?php
                  if ($message !== false) {
                    ...
                    $o .= "<div>";
                      ...
                      $o .= "<h4>Location: <i><b>" . $message['location'] . ( $message['destination'] ? (" | ".$message['destination']) : "") . "</b></i></h4>";
                       $o .= "<h2>" . $message['title'] . "</h2>";
                      $o .= "<h3>" . $message['category'] . "</h3>";
                      $o .= "<h4>" . $message['sub_category'] . "</h4>";

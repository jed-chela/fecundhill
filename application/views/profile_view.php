  ...
  <section class="module module-padding-top-off">
    <div class="container">
      <div class="">
        ...
        <div class="">
          <h4 class="font-alt">MY PROFILE</h4>
        ...
        <div class="form-group hidden">
          <label>No of Children &nbsp; &nbsp; &nbsp; </label><?php echo $my_info['children']; ?>
        </div>
        ...
        <div class="form-group">
          <label>Business Name/Place or Employment &nbsp; &nbsp; &nbsp; </label><?php echo $my_info['employer_name']; ?>
        </div>
        <div class="form-group">
          <label>Start Date &nbsp; &nbsp; &nbsp; </label><?php echo $my_info['employment_date']; ?>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label>Office/Work Designation(Rank) &nbsp; &nbsp; &nbsp; </label><?php echo $my_info['employer_rank']; ?>
        </div>
        <div class="form-group">
